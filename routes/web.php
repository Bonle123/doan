...
Route::group(['namespace' => 'Frontend'], function() {
    ...
    Route::get('danh-muc/{slug}','CategoryController@index')->name('get.category.list'); // list sp theo danh mục
    ...
    Route::prefix('shopping')->group(function () {
       ...
       Route::get('thanh-toan','ShoppingCartController@callbackPay')->name('get.callback.pay');
    });

    //Comment
    Route::group(['prefix' => 'comment', 'middleware' => 'check_user_login'], function(){ 
        //Route::get('comment','ProductController@index')->name('get.product.list'); // list sp
