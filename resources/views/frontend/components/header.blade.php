<section class="top-header desktop" style="background: #006600 !important ">
    <div class="container">
        <div class="content">
            <div class="left">
                <a href="{{ route('get.static.customer_care') }}" title="Customer care" rel="nofollow">Chăm sóc khách hàng</a>
                 <a href="{{ route('get.user.transaction') }}" title="Check your order" rel="nofollow">Kiểm tra đơn hàng</a>
            </div>
            <div class="right">
                @if (Auth::check())
                    <a href="">Hi {{ Auth::user()->name }}</a>
                    <a href="{{  route('get.user.dashboard') }}">Tổng quan</a>
...
<section class="top-header mobile" style="background: #006600 !important">
    <div class="container">
        <div class="content">
            <div class="left">
                <a href="{{ route('get.static.customer_care') }}" title="Customer care" rel="nofollow">Chăm sóc khách hàng</a>
...
<div class="commonTop" style="position: unset !important;">
    <div id="headers" style="background: #009900 !important ">
        <div class="container header-wrapper">
            <!--Thay đổi-->
            <div class="logo">
                <a href="{{  route('get.home') }}" class="desktop">
                    <img src="{{ asset('images/mypham.png') }}" style="height: 35px;" alt="Home">
                </a>
            ...
            <div class="search">
                ...
                <form action="{{ $link_search ?? route('get.product.list',['k' => Request::get('k')]) }}" role="search" method="GET">
                    ...
                    <button type="submit" class="btnSearch" style="background: #009900;border: 1px solid #009900">
            ...
            <div id="menu-main" class="container" style="display: none">
                <ul class="menu-list">
                    ...
                    @endforeach
                        <li><a href="{{ route('get.product.list') }}">Tất cả sản phẩm</a></li>
                </ul>
            </div>
        </div>
