                ...
                <div class="customer__content">
                    <form class="from_cart_register" action="{{ route('post.shopping.pay') }}" method="post">
                        ...
                        <div class="btn-buy" style="margin-top: 10px">
                            <button class="buy1 btn btn-pink {{ \Auth::id() ? '' : 'js-show-login' }}" style="width: 100%;border-radius: 5px" type="submit" name="pay" value="vnpay">
                                Thanh toán Online
                            </button>
                        </div>
{{--                        <div class="btn-buy" style="margin-top: 10px">--}}
{{--                            <button class="buy1 btn btn-success {{ \Auth::id() ? '' : 'js-show-login' }} " style="width: 100%;border-radius: 5px" type="submit" name="pay" value="vnpay">--}}
{{--                                Thanh toán VnPay--}}
{{--                            </button>--}}
{{--                        </div>--}}
                    </form>
